...
*A Haunting of Haunts* is a collection of media packs that allow artists to reenact or create landmark performance art within the context of networked performance. It provides media in image and 3D formats that can be included within a number of networked environments.
...
During the lockdowns of the Covid 19 pandemic in 2020 networked technologies that were not particularly new or innovative were rediscovered as a means to communicating during social distancing. Video conferencing in particular quickly become the standard adopted means of work, education and collaboration. In a sense old become new again, was presented as if it never was, quickly integrated as part of essential communication infrastructures and its use became a key skill.
